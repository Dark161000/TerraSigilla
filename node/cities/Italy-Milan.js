...
async function getData(e) {
    ...
    let apiData = '';
    const soCoords = '45.388046475559335,9.060698810936936',
    neCoords = '45.54036975900509,9.300787108506096';
    ...
    if (!fs.existsSync(path.join(__dirname,'../../data/Italy-Milan.txt'))) {
        ...
        const fileData = fs.readFileSync(path.join(__dirname,'../../data/Italy-Milan.txt'),'utf-8', (err) => {if(err){console.error('Error reading file: ', err)}});
